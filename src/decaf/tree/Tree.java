...
public abstract class Tree {
    ...
    public static final int ARRAYREPEAT = VARIDENT + 1;
    public static final int CONCAT = ARRAYREPEAT + 1;
    public static final int SUBARRAY = CONCAT + 1;
    public static final int DEFAULT = SUBARRAY + 1;
    ...
    public static class ClassDef extends Tree {
        ...
        public ClassDef(boolean _sealed, String name, String parent, List<Tree> fields,
    			Location loc) {
    		super(CLASSDEF, loc);
    		this.sealed = _sealed;
    		this.name = name;
    ...
    public static class Scopy extends Tree {
        ...
        public Scopy(String _dst, Expr _expr, Location loc) {
            super(SCOPY, loc);
            this.expr = _expr;
            this.dst = _dst;
        }
    ...
    public static class ArrayRepeat extends Expr {
        ...
        public ArrayRepeat(Expr expr, int typeTag, Object value, Location loc) {
        ...
        @Override
        public void accept(Visitor visitor) { visitor.visitArrayRepeat(this); }
    ...
    public static class Concat extends Expr {
        ...
        public Concat(Expr left, Expr right, Location loc) {
            super(CONCAT, loc);
            this.left = left;
            this.right = right;
        }
        ...
        @Override
        public void accept(Visitor visitor) { visitor.visitConcat(this); }
    ...
    public static class SubArray extends Expr {
        ...
        public SubArray(Expr e1, Expr e2, Expr e3, Location loc) {
            super(SUBARRAY, loc);
            this.e1 = e1;
            this.e2 = e2;
            this.e3 = e3;
        ...
        @Override
        public void accept(Visitor vistor) { vistor.visitSubArray(this); }
    ...
    public static class Default extends Expr {
        ...
        public Default(Expr e1, Expr e2, Expr e3, Location loc) {
            super(DEFAULT, loc);
            this.e1 = e1;
            this.e2 = e2;
            this.e3 = e3;
        ...
        @Override
        public void accept(Visitor visitor) { visitor.visitDefault(this); }
    ...
    public static class VarIdent extends LValue {
        ...
        @Override
        public void accept(Visitor v) { v.visitVarIdent(this); }
    ...
    public static abstract class Visitor {
        ...
        public void visitVarIdent(VarIdent that) { visitTree(that); }

        public void visitArrayRepeat(ArrayRepeat that) { visitTree(that); }

        public void visitConcat(Concat that) { visitTree(that); }

        public void visitSubArray(SubArray that) { visitTree(that); }
